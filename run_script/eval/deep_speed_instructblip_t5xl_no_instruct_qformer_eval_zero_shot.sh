...
export EXPERIMENT_NAME=instruct_BLIP2_deepSpeed_t5xl_no_instructqformer_eval_zero_shot
...
for dataset in "${datasets[@]}"; do
  echo "Running evaluation for dataset: $dataset" 
    EXPERIMENT_NAME=instruct_BLIP2_deepSpeed_t5xl_no_instructqformer_eval_${dataset} 
    ...
    --test_file /home/haozhezhao/Vision-PromptSource/prompt_data_6_12_zero-shot_json/bilp2-prompt-allshot-multiinst_final_ver/${dataset}/\*/ \
    --do_train $do_train \
    --do_eval $do_valid \
    --do_predict $do_test \
