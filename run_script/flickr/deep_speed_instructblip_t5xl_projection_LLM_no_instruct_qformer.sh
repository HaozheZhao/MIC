...
export EXPERIMENT_NAME=instruct_BLIP2_deepSpeed_t5xl_unfreeze_Projection_LLM3layer_videodata_no_instructqformer
...
--run_name instructblip-flan-t5-xl-Projection_LLM3layer_videodata_no_instructqformer \
