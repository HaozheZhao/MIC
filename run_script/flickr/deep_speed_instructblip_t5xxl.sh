...
export EXPERIMENT_NAME=instruct_BLIP_deepSpeed_t5xxl
export DATASET_NAME=flickr
export CUDA_VISIBLE_DEVICES=1,2,3,4,5,6
export MODEL_DIR=models/
export NCCL_P2P_LEVEL=NVL
export MODEL_NAME=instructblip-flan-t5-xxl
model_name_or_path=model/instructblip-flan-t5-xxl
processor_path=model/instructblip-flan-t5-xxl
...
--train_file ${data_dir}/MMICL_t5_json/train/train.jsonl \
--validation_file ${data_dir}/MMICL_t5_json/val/val.jsonl \
--test_file ${data_dir}/MMICL_t5_json/test/test.jsonl \
--do_train $do_train \
--do_eval $do_valid \
--do_predict $do_test \
