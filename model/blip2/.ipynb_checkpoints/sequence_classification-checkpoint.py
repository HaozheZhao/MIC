...
class BertPrefixForSequenceClassification(BertPreTrainedModel):
    def __init__(self, config, model_args):
        ...
        self.prefix_encoder = PrefixEncoder(self.config, self.model_args)
    ...
    def get_prompt(self, batch_size, sentences_ids):
        ...
        if self.model_args.prompt_operation in ["attention"]:
            ...
            past_key_values = self.prompt_encoder(sentences_ids, attention_mask_sentences_ids) # batch_size * pre_seq_length * hidden_size
        else:
    ...
    def forward(
        ...
        past_key_values = self.get_prompt(batch_size, sentences_ids)
